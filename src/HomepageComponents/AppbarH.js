...
const NavBarH = () => (
    ...
    <Paper style={style} zDepth={1} className = "NavBar-paper">
      <FlatButton className = "nav-buttons" label="Home" hoverColor = '#0084b4' icon={<ActionHome hoverColor = "white"/>}></FlatButton>
...
*/}
      <TwitterIcon size= {30} style = {faviconStyle}/>
      ...
      <Avatar src= "http://res.cloudinary.com/ddskvkjzs/image/upload/v1514225611/6TY0EjQh_400x400_rqcbun.jpg" size={35} backgroundColor={white} style = {profile}/>
